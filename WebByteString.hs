...
-- TODO eugh, this crashes
-- TODO how efficient are SBSs? do we need them anyway or is there another way to go from BS to `ByteArray`?
main :: IO ()
main = B.putStr $ SB.fromShort $ byteStringFromJSBytes $ byteStringToJSBytes $ SB.toShort $ encodeUtf8 "lorem ipsum"
